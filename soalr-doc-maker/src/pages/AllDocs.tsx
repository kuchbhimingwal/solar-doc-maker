...
import AllFormComponent from "../components/AllFormComponent"; // Import the form you created
...
const AllDocs = () => {
  ...
  return (
    <div className="App">
      ...
      <h1 className="text-2xl font-bold mb-6 text-green-600 text-center">Fill the Form to Generate all the documents</h1>
      <AllFormComponent onSubmit={handleSubmit} />
      </div>
      </div>
    </div>
  );
